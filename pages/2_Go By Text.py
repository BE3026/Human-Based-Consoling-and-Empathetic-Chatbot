...
if prompt := st.chat_input("What is up?"):
    ...
    if sentiment=='negative':
        userinp='I am saying the next sentence in a negative emotion , so try to motivate me on the situation and ask whether you could tell me a joke or a motivational quote , you can ask any of the two , if i say yes respond accordingly or else skip.\n' +userinp 
